...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                  ...
                                  <img src="<?php echo base_url('assets/assets/img/address-loader.gif'); ?>"  class='img-responsive'>
                                   ...
                                   <div class="modal-header">
                                      <h2 class="modal-title">
                                         ...
                                         <p style="font-size: 14px;">Instantly send Zedexcoin to any Zedexcoin address.</p>
                                      </h2>
                                      ...
                                      <div class="send-div-2">
                                         <form>
                                            <div class="form-group">
                                              ...
                                              <input class="form-control wallet-password" data-crypto='<?php  echo strtolower($current_wallet->current_wallet); ?>' placeholder="Enter your password" type="text">
                ...
                <button type="button" data-crypto='<?php echo $current_wallet->current_wallet; ?>'  data-valid='false' class="btn btn-primary <?php echo $class; ?>">Next</button>
                <button type="button" data-crypto='<?php echo $current_wallet->current_wallet; ?>'  data-valid='false' class="btn btn-primary send-crypto-btn ">Proceed</button>
                             ...
                             <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                   <div class="modal-header">
                                      <h2 class="modal-title">
                                         Receive<br>
                                         <p style="font-size: 14px;">A new address has been created for you to receive zedexcoin</p>
                                      </h2>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">×</span>
                                      </button>
